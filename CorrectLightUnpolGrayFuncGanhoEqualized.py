...
funçãoGanhoGray1=EqualizedGrayRoi1/RoiGray1[maxPicoPositivo]
funçãoGanhoGray2=RoiGray2/RoiGray2[maxPicoPositivo]
funçãoGanhoGray3=RoiGray3/RoiGray3[maxPicoPositivo]

IntensityGrayCorrect1=EqualizedGrayRoi1/funçãoGanhoGray1
IntensityGrayCorrect2=EqualizedGrayRoi1/funçãoGanhoGray2
IntensityGrayCorrect3=EqualizedGrayRoi1/funçãoGanhoGray3

outputImageGraph = f"ETeste1GrayscaleFGanho{folder_name}{video_name}.png"
plotCurveFGanho(time_stamps,EqualizedGrayRoi1, RoiGray2, RoiGray3, funçãoGanhoGray1,funçãoGanhoGray2,funçãoGanhoGray3,
                  IntensityGrayCorrect1,IntensityGrayCorrect2,IntensityGrayCorrect3, outputImageGraph)

outputImageGraphJuntos = f"ETeste1GrayscaleFGanhoCombinado{folder_name}{video_name}.png"
plotCurveFGanhoJuntos(time_stamps,EqualizedGrayRoi1, RoiGray2, RoiGray3, funçãoGanhoGray1,funçãoGanhoGray2,funçãoGanhoGray3,
                  IntensityGrayCorrect1,IntensityGrayCorrect2,IntensityGrayCorrect3, outputImageGraphJuntos)


try:
    IntesityGrayROI1 = np.column_stack((EqualizedGrayRoi1, EqualizedGrayRoi1, EqualizedGrayRoi1))
    ...
    outputFilePCRT = f"EpCRTGrayTeste1ROI1{video_name}.png"
...
try:
    ...
    pcrtComp.showPCRTPlot()
    outputFilePCRT = f"EpCRTGrayTeste1ROI1CorrectROI2{video_name}.png"
    pcrtComp.savePCRTPlot(outputFilePCRT)
    print(pcrtComp)
except Exception as e:
...
try:
    ...
    pcrtComp.showPCRTPlot()
    outputFilePCRT = f"EpCRTGrayTeste1ROI1CorrectROI3{video_name}.png"
    pcrtComp.savePCRTPlot(outputFilePCRT)
    print(pcrtComp)
except Exception as e:
...
funçãoGanhoGray1=EqualizedGrayRoi1/EqualizedGrayRoi1[10]
...
outputImageGraph = f"ETeste2GrayscaleFGanho{folder_name}{video_name}.png"
plotCurveFGanho(time_stamps,EqualizedGrayRoi1, RoiGray2, RoiGray3, funçãoGanhoGray1,funçãoGanhoGray2,funçãoGanhoGray3,
                  IntensityGrayCorrect1,IntensityGrayCorrect2,IntensityGrayCorrect3, outputImageGraph)
...
try:
    ...
    pcrtComp = PCRT(time_stamps, IntesityGrayROI1, exclusionMethod='best fit', exclusionCriteria=9999, fromTime=tempoMaxPicoPositivo)
    pcrtComp.showPCRTPlot()
    outputFilePCRT = f"EpCRTGrayTeste2ROI1{video_name}.png"
    pcrtComp.savePCRTPlot(outputFilePCRT)
    print(pcrtComp)
...
try:
    ...
    pcrtComp = PCRT(time_stamps, IntesityGrayROI1CorrectROI2, exclusionMethod='best fit', exclusionCriteria=9999, fromTime=tempoMaxPicoPositivo)
    pcrtComp.showPCRTPlot()
    outputFilePCRT = f"EpCRTGrayTeste2ROI1CorrectROI2{video_name}.png"
    pcrtComp.savePCRTPlot(outputFilePCRT)
    print(pcrtComp)
except Exception as e:
...
try:
    ...
    pcrtComp = PCRT(time_stamps, IntesityGrayROI1CorrectROI3, exclusionMethod='best fit', exclusionCriteria=9999, fromTime=tempoMaxPicoPositivo)
    pcrtComp.showPCRTPlot()
    outputFilePCRT = f"EpCRTGrayTeste2ROI1CorrectROI3{video_name}.png"
    pcrtComp.savePCRTPlot(outputFilePCRT)
    print(pcrtComp)
except Exception as e:
...
funçãoGanhoGray1=EqualizedGrayRoi1/EqualizedGrayRoi1[400]
...
outputImageGraph = f"ETeste3GrayscaleFGanho{folder_name}{video_name}.png"
plotCurveFGanho(time_stamps,EqualizedGrayRoi1, RoiGray2, RoiGray3, funçãoGanhoGray1,funçãoGanhoGray2,funçãoGanhoGray3,
                  IntensityGrayCorrect1,IntensityGrayCorrect2,IntensityGrayCorrect3, outputImageGraph)

try:
    IntesityGrayROI1 = np.column_stack((EqualizedGrayRoi1, EqualizedGrayRoi1, RoiGrEqualizedGrayRoi1ay1))
    pcrtComp = PCRT(time_stamps, IntesityGrayROI1, exclusionMethod='best fit', exclusionCriteria=9999, fromTime=tempoMaxPicoPositivo)
    pcrtComp.showPCRTPlot()
    outputFilePCRT = f"EpCRTGrayTeste3ROI1{video_name}.png"
    pcrtComp.savePCRTPlot(outputFilePCRT)
    print(pcrtComp)
...
try:
    ...
    pcrtComp = PCRT(time_stamps, IntesityGrayROI1CorrectROI2, exclusionMethod='best fit', exclusionCriteria=9999, fromTime=tempoMaxPicoPositivo)
    pcrtComp.showPCRTPlot()
    outputFilePCRT = f"EpCRTGrayTeste3ROI1CorrectROI2{video_name}.png"
    pcrtComp.savePCRTPlot(outputFilePCRT)
    print(pcrtComp)
except Exception as e:
...
try:
    ...
    pcrtComp = PCRT(time_stamps, IntesityGrayROI1CorrectROI3, exclusionMethod='best fit', exclusionCriteria=9999, fromTime=tempoMaxPicoPositivo)
    pcrtComp.showPCRTPlot()
    outputFilePCRT = f"EpCRTGrayTeste3ROI1CorrectROI3{video_name}.png"
    pcrtComp.savePCRTPlot(outputFilePCRT)
    print(pcrtComp)
except Exception as e:
